        ...
        <div className="container-fluid default-list-container">
            ...
            <div className="container-fluid py-4" style={{ backgroundColor: '#f8f9fa' }}>
                ...
                <div className="text-center mb-5 default-list-header">
                    <h1 className="default-list-header-title">Minhas Recomendações</h1>
                    <p className="default-list-header-subtitle">Histórico das suas recomendações personalizadas</p>
                            ...
                            <div className="card-header default-list-card-header">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 className="default-list-card-title">Minhas Recomendações</h4>
                                                    ...
                                                    >
                                                        <div className="d-flex flex-column align-items-center default-list-empty-container">
                                                            ...
                                                            <p className="text-muted mb-0">
                                                                {currentPage === 0 ? "Crie sua primeira recomendação para começar" : "Tente navegar para outra página"}
                                                            </p>
                                                            <div className="mt-3">
                                                                <Button
                                                                    cor="dark"
